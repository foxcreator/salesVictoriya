                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            @foreach($products as $product)
                                <tr>
                                    <form action="{{ route('admin.product.update-price', $product->id) }}" method="POST">
                                        @csrf
                                        <th scope="row">
                                        ...
                                        <td class="w-25">
                                            <div class="row d-flex justify-content-end">
                                                <button type="submit" class="btn btn-outline-info col-md-5 me-2">
                                                    Обновить
                                                </button>

                                                <a href="{{ route('admin.product.edit', $product->id) }}"
                                                   class="btn btn-outline-warning col-md-5 me-2">Изменить</a>
                                            </div>
                                        </td>
                                    </form>
                                    <td>
                                        <form action="{{ route('admin.product.delete', $product->id) }}" method="POST">
                                            @csrf
                                            <button type="submit" class="btn btn-outline-danger col-md-12">Удалить
                                            </button>
                                        </form>
                                    </td>
                                </tr>
